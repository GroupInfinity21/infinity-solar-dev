      ...
      <div className="max-w-2xl w-full bg-white rounded-2xl shadow-xl p-6 md:p-8">
        ...
        <div className="space-y-6 text-center">
          ...
          <div className="space-y-4 text-custom">
            ...
            <p className="text-gray-700">
              Mas se você já quiser adiantar e largar na frente dos vários cadastros que recebemos
              diariamente, criamos um canal exclusivo de atendimento rápido.
            </p>
          </div>

          <div className="pt-6" onClick={openWpp}>
            <a className="inline-flex items-center gap-2 bg-accent hover:bg-accent/90 text-white px-6 py-3 rounded-full font-semibold transition-colors">
